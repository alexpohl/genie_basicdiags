def genielat(latdata_edge, zdata_edge, data, cmapdata, levdata, tickdata, extendata, lowercolor, uppercolor, titledata, fnamedata, contourplotflag, latdata, zdata, clevdata, lwdata, logdata):
    nx = np.shape(data)[0]
    ny = np.shape(data)[1]
